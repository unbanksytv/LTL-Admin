            ...
            function(t, e) {
              !(function() {
                    ...
                    if (i) {
                      if (!e.isDragging) {
                        ...
                        n ||
                          ...
                          (n = i.getStage().getPointerPosition()));
                  ...
                  _endDragBefore: function(t) {
                    ...
                    n &&
                      ...
                      i.isDragging &&
                        ...
                        t && (t.dragEndNode = n)),
                      delete i.node,
                      (n.getLayer() || e || n instanceof Konva.Stage) &&
                        (e || n).draw());
                  },
                ...
                (Konva.Node.prototype.__originalRemove = t),
                  ...
                  (Konva.Node.prototype._listenDrag = function() {
                    ...
                    this._dragCleanup(),
                      'Stage' === this.getClassName()
                        ? this.on(
                            'contentMousedown.konva contentTouchstart.konva',
                            function(e) {
                              Konva.DD.node || t.startDrag(e);
                            }
                          )
                        : this.on('mousedown.konva touchstart.konva', function(
                            e
                          ) {
                            1 !== e.evt.button &&
                              2 !== e.evt.button &&
                  ...
                  Konva.Factory.addOverloadedGetterSetter(
                    Konva.Node,
                    'draggable'
                  ),
                  Konva.isBrowser &&
            ...
            function(t, e) {
              !(function() {
                ...
                (Konva.Path = function(t) {
                  ...
                  (Konva.Path.prototype = {
                    ___init: function(t) {
                      ...
                      Konva.Shape.call(this, t),
                        (this.className = 'Path'),
                        (this.dataArray = Konva.Path.parsePathData(
                          this.getData()
                        )),
                        (this.pathLength = 0);
                      ...
                      this.on('dataChange.konva', function() {
                        (e.dataArray = Konva.Path.parsePathData(
                          this.getData()
                        )),
                          (this.pathLength = 0);
                    ...
                    getSelfRect: function() {
                      ...
                      for (
                        var e, i, n = t[0], a = t[0], r = t[1], o = t[1], s = 0;
                        s < t.length / 2;
                        s++
                      )
                        (e = t[2 * s]),
                  ...
                  (Konva.Path.getPointOnEllipticalArc = function(
                    t,
                    e,
                    i,
                    n,
                  ...
                  (Konva.Path.parsePathData = function(t) {
                    ...
                    for (n = 1; n < r.length; n++) {
                      var d = r[n],
                        u = d.charAt(0);
                      for (d = d.slice(1), s.length = 0; (a = c.exec(d)); )
                        s.push(a[0]);
              ...
              !(function(t) {
                ...
                (t.Circle = function(t) {
                  ...
                  (t.Circle.prototype = {
                    ...
                    setWidth: function(e) {
                      t.Node.prototype.setWidth.call(this, e),
                        this.radius() !== e / 2 && this.setRadius(e / 2);
                    },
                    setHeight: function(e) {
                      t.Node.prototype.setHeight.call(this, e),
                        this.radius() !== e / 2 && this.setRadius(e / 2);
                    },
                  }),
                  ...
                  t.Factory.addGetterSetter(
                    ...
                    'radius',
                    0,
                    t.Validators.getNumberValidator()
                  ),
                ...
                (Konva.FastLayer = function(t) {
                  ...
                  Konva.Util.addMethods(Konva.FastLayer, {
                    ...
                    _validateAdd: function(t) {
                      'Shape' !== t.getType() &&
                        Konva.Util.throw(
                          'You may only add shapes to a fast layer.'
                        );
                    },
                    ...
                    setVisible: function(t) {
                      return (
                        ...
                        (this.getCanvas()._canvas.style.display = t
                          ? 'block'
                          : 'none'),
                        this
                      );
                ...
                (Konva.Layer = function(t) {
                  ...
                  Konva.Util.addMethods(Konva.Layer, {
                    ...
                    setSize: function(t, e) {
                      return (
                        Konva.BaseLayer.prototype.setSize.call(this, t, e),
                        ...
                        ? (e.content.removeChild(this.getCanvas()._canvas),
                          this.index < e.getChildren().length - 1
                            ? e.content.insertBefore(
                                this.getCanvas()._canvas,
                                e.getChildren()[this.index + 1].getCanvas()
                                  ._canvas
                              )
                            : e.content.appendChild(this.getCanvas()._canvas),
                          this)
                ...
                (Konva.Stage = function(t) {
                  ...
                  Konva.Util.addMethods(Konva.Stage, {
                    ...
                    _validateAdd: function(t) {
                      'Layer' !== t.getType() &&
                        Konva.Util.throw(
                          'You may only add layers to the stage.'
                        );
                    },
                      ...
                      if ('string' == typeof t) {
                        if ('.' === t.charAt(0)) {
                          ...
                          (i = '#' !== t.charAt(0) ? t : t.slice(1)),
                            (t = Konva.document.getElementById(i));
                        }
                        if (!t)
                    ...
                    setHeight: function(t) {
                      return (
                        Konva.Node.prototype.setHeight.call(this, t),
                        this._resizeDOM(),
                        this
                      );
                    },
                    setWidth: function(t) {
                      return (
                        Konva.Node.prototype.setWidth.call(this, t),
                        this._resizeDOM(),
                        this
                      );
                    },
                    ...
                    getIntersection: function(t, e) {
                      ...
                      for (i = a.length - 1; i >= 0; i--)
                        if ((n = a[i].getIntersection(t, e))) return n;
                      return null;
                    },
                    _resizeDOM: function() {
                      if (this.content) {
                    ...
                    _mousedown: function(t) {
                      ...
                      if (!Konva.UA.mobile) {
                        ...
                        (Konva.listenClickTap = !0),
                          e && e.isListening()
                            ? ((this.clickStartShape = e),
                              e._fireAndBubble('mousedown', { evt: t }))
                            ...
                            ? ((this.clickEndShape = e),
                              ...
                              Konva.listenClickTap &&
                                ...
                                a &&
                                  n &&
                                  n._id === e._id &&
                                  e._fireAndBubble('dblclick', { evt: t })))
                            : (this._fire('mouseup', {
                                evt: t,
                                target: this,
                                currentTarget: this,
                    ...
                    _onContent: function(t, e) {
                      var i,
                        ...
                        r = a.length;
                      for (i = 0; i < r; i++)
                        (n = a[i]), this.content.addEventListener(n, e, !1);
                    },
                    cache: function() {
                      Konva.Util.warn(
                ...
                (t.Shape = function(t) {
                  ...
                  t.Util.addMethods(t.Shape, {
                    __init: function(e) {
                      ...
                      for (
                        var i, l = t.shapes;
                        !(i = t.Util.getRandomColor()) || i in l;
                    ...
                    destroy: function() {
                      return (
                        t.Node.prototype.destroy.call(this),
                      ...
                      if ((h.save(), this._useBufferCanvas(i) && !n)) {
                        ...
                        d && u && !s.hitCanvas
                          ? (h.save(),
                            ...
                            h.restore(),
                            this.hasFill() &&
                              this.getShadowForStrokeEnabled() &&
                              c.call(this, h, this))
                          : d && !s.hitCanvas
                          ? (h.save(),
                            i ||
                    ...
                    drawHitFromCache: function(e) {
                      ...
                      try {
                        for (
                          a = (n = (i = d.getImageData(0, 0, u, f)).data)
                            .length,
                  ...
                  t.Factory.addComponentsGetterSetter(t.Shape, 'shadowOffset', [
                    'x',
                    'y',
                  ]),
                  t.Factory.addGetterSetter(
                  ...
                  t.Factory.addComponentsGetterSetter(
                    t.Shape,
                    'fillPatternOffset',
                    ['x', 'y']
                  ),
                ...
                (Konva.Container = function(t) {
                  ...
                  Konva.Util.addMethods(Konva.Container, {
                    ...
                    removeChildren: function() {
                      for (
                        var t,
                          e = Konva.Collection.toCollection(this.children),
                          i = 0;
                        i < e.length;
                        i++
                      )
                    ...
                    add: function(t) {
                      ...
                      return (
                        ...
                        Konva.DD &&
                          t.isDragging() &&
                          Konva.DD.anim.setLayers(t.getLayer()),
                        this
                      );
                    },
                    destroy: function() {
                    ...
                    _findByString: function(t) {
                      ...
                      for (e = 0; e < c; e++) {
                        ...
                        if ('#' === n.charAt(0))
                          (r = this._getNodeById(n.slice(1))) && h.push(r);
                        else if ('.' === n.charAt(0))
                          (a = this._getNodesByName(n.slice(1))),
                            (h = h.concat(a));
                        else
                          for (
                            s = (o = this.getChildren()).length, i = 0;
                            i < s;
                            i++
                          )
                    ...
                    toObject: function() {
                      ...
                      t.children = [];
                      for (
                        var e = this.getChildren(), i = e.length, n = 0;
                        n < i;
                        n++
                      ) {
                        var a = e[n];
                    ...
                    shouldDrawHit: function(t) {
                      var e = this.getLayer(),
                        i =
                          Konva.DD &&
                          Konva.isDragging() &&
                          -1 !== Konva.DD.anim.getLayers().indexOf(e);
                      return (
                        (t && t.isCache) ||
                        (e && e.hitGraphEnabled() && this.isVisible() && !i)
                      );
                    },
                    getClientRect: function(t) {
                      var e,
                  ...
                  (Konva.Container.prototype.get =
                    Konva.Container.prototype.find),
              ...
              !(function(t) {
                ...
                (t.Node = function(t) {
                  ...
                  t.Util.addMethods(t.Node, {
                      ...
                      if (r) {
                        if (!this._filterUpToDate) {
                          ...
                          try {
                            ...
                            t.Util.error(
                              'Unable to apply filter. ' + e.message
                            );
                          }
                    ...
                    _delegate: function(e, i, n) {
                      ...
                      this.on(e, function(e) {
                        for (
                          var r = e.target.findAncestors(i, !0, a), o = 0;
                          o < r.length;
                          o++
                        )
                          ((e = t.Util.cloneObject(e)).currentTarget = r[o]),
                            n.call(r[o], e);
                      });
                    },
                    remove: function() {
                    ...
                    destroy: function() {
                      ...
                      for (
                        var e = (this.getName() || '').split(/\s/g), i = 0;
                        i < e.length;
                        i++
                      ) {
                        var n = e[i];
                    ...
                    getAttr: function(e) {
                      ...
                      return t.Util._isFunction(this[i])
                        ? this[i]()
                        : this.attrs[e];
                    },
                    getAncestors: function() {
                      for (
                        var e = this.getParent(), i = new t.Collection();
                        e;

                      )
                        i.push(e), (e = e.getParent());
                      return i;
                    },
                    getAttrs: function() {
                      return this.attrs || {};
                          ...
                          (function h(l) {
                            for (t = [], i = l.length, n = 0; n < i; n++)
                              (a = l[n]),
                                s++,
                                a.nodeType !== e &&
                                  (t = t.concat(a.getChildren().toArray())),
                                a._id === o._id && (n = i);
                    ...
                    toObject: function() {
                      ...
                      for (e in ((r.attrs = {}), o))
                        (i = o[e]),
                          ...
                          a !== i && (r.attrs[e] = i);
                      return (
                        (r.className = this.getClassName()),
                        t.Util._prepareToStringify(r)
                      );
                    },
                    toJSON: function() {
                    ...
                    clone: function(e) {
                      ...
                      for (n in this.eventListeners)
                        for (
                          r = (a = this.eventListeners[n]).length, o = 0;
                          o < r;
                          o++
                        )
                    ...
                    _toKonvaCanvas: function(e) {
                      ...
                      var i = this.getClientRect(),
                        ...
                        s = new t.SceneCanvas({
                          ...
                          height:
                            e.height || i.height || (n ? n.getHeight() : 0),
                          pixelRatio: o,
                        }),
                        h = s.getContext();
                      return (
                        h.save(),
                        (a || r) && h.translate(-1 * a, -1 * r),
                        this.drawScene(s),
                        h.restore(),
                        s
                      );
                    ...
                    setSize: function(t) {
                      return (
                        this.setWidth(t.width), this.setHeight(t.height), this
                      );
                    },
                    getSize: function() {
                      return {
                    ...
                    setName: function(e) {
                      ...
                      for (n = 0; n < a.length; n++)
                        (i = a[n]),
                          -1 === r.indexOf(i) &&
                            i &&
                            t._removeName(i, this._id);
                      for (n = 0; n < r.length; n++)
                        (i = r[n]),
                          -1 === a.indexOf(i) && i && t._addName(this, i);
                    ...
                    removeName: function(t) {
                      var e = (this.name() || '').split(/\s/g),
                        i = e.indexOf(t);
                      return (
                        -1 !== i && (e.splice(i, 1), this.setName(e.join(' '))),
                        this
                      );
                    },
                    ...
                    _fire: function(t, e) {
                      ...
                      if (
                        (((e = e || {}).currentTarget = this), (e.type = t), n)
                      )
                  ...
                  (t.Node.create = function(e, i) {
                    return (
                      t.Util._isString(e) && (e = JSON.parse(e)),
                      this._createNode(e, i)
                    );
                  }),
                  (t.Node._createNode = function(e, i) {
                    var n,
                      ...
                      s = e.children;
                    if (
                      (i && (e.attrs.container = i), (n = new t[o](e.attrs)), s)
                    )
                      for (a = s.length, r = 0; r < a; r++)
                        n.add(this._createNode(s[r]));
                    return n;
                  }),
                  ...
                  t.Factory.addComponentsGetterSetter(t.Node, 'scale', [
                    'x',
                    'y',
                  ]),
                  t.Factory.addGetterSetter(
                  ...
                  t.Factory.addComponentsGetterSetter(t.Node, 'skew', [
                    'x',
                    'y',
                  ]),
                  t.Factory.addGetterSetter(
                  ...
                  t.Factory.addComponentsGetterSetter(t.Node, 'offset', [
                    'x',
                    'y',
                  ]),
                  t.Factory.addGetterSetter(
                  ...
                  t.Factory.addGetterSetter(t.Node, 'filters', null, function(
                    t
                  ) {
                ...
                (Konva.Context = function(t) {
                  ...
                  (Konva.SceneContext.prototype = {
                    ...
                    _fillPattern: function(t) {
                      ...
                      (e || i) && this.translate(e || 0, i || 0),
                        ...
                        this.setAttr(
                          'fillStyle',
                          this.createPattern(
                            t.getFillPatternImage(),
                            t.getFillPatternRepeat() || 'repeat'
                          )
                        ),
                        this.fill();
                    },
                    ...
                    _stroke: function(t) {
                      var e = t.dash(),
                        i =
                          t.getStrokeScaleEnabled() || t instanceof Konva.Text;
                      t.hasStroke() &&
                        (i ||
                    ...
                    _applyShadow: function(t) {
                      ...
                      this.setAttr('shadowColor', i),
                        this.setAttr(
                          'shadowBlur',
                          n * Math.min(Math.abs(s), Math.abs(h))
                        ),
                  ...
                  (Konva.Canvas.prototype = {
                    init: function(e) {
                      var i =
                        ...
                        (function() {
                          if (t) return t;
                          var e = Konva.Util.createCanvasElement().getContext(
                            '2d'
                          );
                          return (t =
              ...
              !(function() {
                ...
                (Konva.Collection = function() {
                  ...
                  (Konva.Transform.prototype = {
                    ...
                    invert: function() {
                      var t =
                          1 / (this.m[0] * this.m[3] - this.m[1] * this.m[2]),
                        e = this.m[3] * t,
                        i = -this.m[1] * t,
                        n = -this.m[2] * t,
                        a = this.m[0] * t,
                ...
                Konva.Util = {
                    ...
                    t
                      ? this._isElement(t)
                        ...
                        ? (((i = new Konva.window.Image()).onload = function() {
                          ...
                          (i.src = t))
                        : t.data
                        ? (((n = Konva.Util.createCanvasElement()).width =
                            t.width),
                          (n.height = t.height),
                  ...
                  extend: function(t, e) {
                    ...
                    var n = t.prototype;
                    for (var a in ((t.prototype = new i()), n))
                      ...
                      e.forEach(function(r, o) {
                        if (i || o !== e.length - 1) {
                          var s = e[(o + 1) % e.length],
                            h = Konva.Util._getProjectionToSegment(
                              r.x,
                              r.y,
                              s.x,
                              s.y,
                  ...
                  _prepareArrayForTween: function(t, e, i) {
                    ...
                    for (n = 0; n < t.length; n += 2)
                      a.push({ x: t[n], y: t[n + 1] });
                    for (n = 0; n < e.length; n += 2)
                      r.push({ x: e[n], y: e[n + 1] });
                    var s = [];
                    return (
                    ...
                    t))
                      if (
                        ...
                        if (
                          ...
                          t[i].visitedByCircularReferenceRemoval ||
                            Konva.Util._isElement(t[i]))
                        ) {
                          if (!e.configurable) return null;
                          delete t[i];
                        } else if (
                          null === Konva.Util._prepareToStringify(t[i])
                        ) {
                          if (!e.configurable) return null;
                          delete t[i];
                        }
                  ...
                  (n = [
                    ...
                    },
                    {
                      ...
                      value: function(t) {
                        if (
                          (t.preventDefault(),
                          this.onBeforeFileLoadCallback(t),
                          t.target.value)
                        ) {
                    ...
                    },
                    {
                      ...
                      value: function() {
                        ...
                        var c = function() {
                          ...
                          v = function(e) {
                            return c(e) >= t.minCropRadius
                              ? e
                              : a.radius() - t.minCropRadius;
                          },
                          p = function(t) {
                          ...
                          b = function(t) {
                            var e =
                              ...
                              (function(t) {
                                ...
                                ? t
                                : 0;
                            r.radius(r.radius() - v(e)),
                              a.radius(a.radius() - v(e)),
                              s.fire('resize');
                          };
                          ...
                          s.on('touchstart', function(e) {
                            s.on('dragmove', function(i) {
                              if ('touchmove' === i.evt.type) {
                                var n =
                                  i.evt.changedTouches[0].pageY -
                                    e.evt.changedTouches[0].pageY || 0;
